...
//  if (SCORE_SIZE == 0) {
//    if (score > 9) drawDigit3x5(score / 10, MX_WIDTH / 2 - 4, MX_HEIGHT / 2 - 3, GLOBAL_COLOR_1);
//    drawDigit3x5(score % 10, MX_WIDTH / 2, MX_HEIGHT / 2 - 3, GLOBAL_COLOR_2);
//  } else {
//    if (score > 9) drawDigit5x7(score / 10, MX_WIDTH / 2 - 6, MX_HEIGHT / 2 - 4, GLOBAL_COLOR_1);
//    drawDigit5x7(score % 10, MX_WIDTH / 2, MX_HEIGHT / 2 - 4, GLOBAL_COLOR_2);
//  }
//  FastLED.show();
}
